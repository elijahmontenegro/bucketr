...
const Home = (props) => {
  ...
  if (error) return <Text>Couldn't connect to the database.</Text>;
  ...
  return (
    <>
      <SideBar>
        <Div>
          <Text textSize="title" m={{ b: "1rem" }} textWeight="500">ATX QA</Text>
      ...
      <Content>
          <Div>
            <Row justify="space-between" w="100%">
              <Col>
                <Text textSize="title" m={{ b: "0.5rem" }} textWeight="500">Welcome, {user.displayName.split(' ')[0]}!</Text>
